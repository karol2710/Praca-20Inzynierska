# KubeChart Documentation

Welcome to KubeChart documentation! This guide covers everything you need to know about deploying and managing Kubernetes applications.
...
🎯 **User-Friendly**: Intuitive UI for managing complex deployments
🔒 **RBAC Support**: Full role-based access control integration
📊 **Resource Management**: Monitor and control resource usage with quotas
🚀 **Traffic Management**: Rate limiting and traffic policy support
🔄 **Hot Reload**: Development mode with hot module replacement
📦 **Docker Ready**: Pre-configured Dockerfile for production deployments

## 📖 How to Use This Documentation

1. **New Users**: Start with [Getting Started](GETTING_STARTED.md)
2. **Deploying an App**: Follow [Deployment Guide](DEPLOYMENT.md)
3. **Setting up Kubernetes**: See [Kubernetes Integration](KUBERNETES.md)
4. **Troubleshooting**: Check [Troubleshooting](TROUBLESHOOTING.md)
5. **Contributing**: Read [Development Guide](DEVELOPMENT.md)

## 🆘 Getting Help

- Check [Troubleshooting](TROUBLESHOOTING.md) for common issues
- Review [API Reference](API.md) for endpoint details
- See [Project Structure](PROJECT_STRUCTURE.md) to understand the codebase
- Check [RBAC Configuration](RBAC.md) for permission-related issues
...
KubeChart is licensed under the MIT License. See the LICENSE file in the root directory.
