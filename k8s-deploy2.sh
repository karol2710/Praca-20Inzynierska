    ...
    spec:
      ...
      initContainers:
        - name: wait-for-postgres
          ...
          command: ['sh', '-c', 'until nc -z postgres.$KUBE_NAMESPACE.svc.cluster.local 5432; do echo waiting for postgres; sleep 2; done; echo "PostgreSQL ready, waiting to avoid race conditions..."; sleep 120']
      containers:
        - name: $DEPLOYMENT_NAME
