...
export default function CreateChart() {
  ...
  const handleAdvancedSubmit = async () => {
    ...
    console.log(
      `[CREATECHART] combineAllYamlDocuments returned ${allYaml.split("\n---\n").length} documents`,
    );
    ...
    for (const resource of resources) {
      ...
      if (resourceYaml) {
        ...
        console.log(
          `[CREATECHART] Added user resource: ${resource.type}/${resource.name}`,
        );
      }
    }
    ...
    if (userResourceYamls.length > 0) {
      ...
      console.log(
        `[CREATECHART] Before adding user resources: ${allDocs.length} documents`,
      );
      allDocs.push(...userResourceYamls);
      console.log(
        `[CREATECHART] After adding user resources: ${allDocs.length} documents`,
      );
      allYaml = allDocs.join("\n---\n");
    }

    console.log(
      `[CREATECHART] Final allYaml has ${allYaml.split("\n---\n").length} documents`,
    );
    console.log(
      `[CREATECHART] Final _allYaml preview:`,
      allYaml.substring(0, 200),
    );
